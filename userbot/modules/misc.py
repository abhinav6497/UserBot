...
async def bot_support(wannahelp):
    ...
    await wannahelp.edit(
        "Join the OUB Remix Channel: @OUBRemix \
...
async def creator(e):
    await e.edit("[Heyworld](https://github.com/abhinav6497)")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[尺 乇 从 工 乂 UserBot's README.md file](https://github.com/abhinav6497/UserBot/blob/sql-extended/README.md)"
